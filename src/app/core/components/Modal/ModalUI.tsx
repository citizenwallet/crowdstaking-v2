        ...
        <motion.section
          ...
          className={
            ...
            (includeContainerStyling
              ? "w-full max-w-[30rem] flex flex-col items-center rounded dark:bg-opacity-100 p-4 bg-breadgray-ultra-white border border-breadgray-light-grey dark:border-none dark:bg-breadgray-charcoal relative"
              : "")
          }
        >
          {showCloseButton && (
